...
#pragma THUNDERHLS MULTIPLE_CU_INDEX kernel_id
#define KERNEL_ID  (#%d# * NRNG  - 1)
...
extern "C" {
#pragma THUNDERHLS MULTIPLE_CU_INDEX rng_instance
    void rng_instance_#%d#(  rng_state_stream_t        &s_in,
